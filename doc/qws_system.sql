...
Source Database       : tig_system

Target Server Type    : MYSQL
Target Server Version : 50616
File Encoding         : 65001

Date: 2017-06-21 09:44:32
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for access.log.stat
-- ----------------------------
DROP TABLE IF EXISTS `access.log.stat`;
CREATE TABLE `access.log.stat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `upstream_id` char(36) DEFAULT NULL,
  `backend` char(22) DEFAULT NULL COMMENT '后台服务器地址',
  `uri` varchar(255) DEFAULT NULL COMMENT 'URL地址',
  `method` char(6) DEFAULT NULL COMMENT '请求方法',
  `status` smallint(4) NOT NULL DEFAULT '200' COMMENT '请求状态',
  `request_num` int(11) NOT NULL DEFAULT '0' COMMENT '请求次数',
  `time` int(12) NOT NULL DEFAULT '0' COMMENT '时间以小时为维度',
  PRIMARY KEY (`id`)
